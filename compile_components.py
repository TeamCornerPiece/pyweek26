...
add_component('CAMERA', ['FOV', 'NEAR', 'FAR', 'DIST', 'DELTA_DIST', 'MIN_PITCH', 'MAX_PITCH'])
add_component('MESH', ['ID', 'TEX_ID', 'SHADER_ID', 'SPEC_R', 'SPEC_G', 'SPEC_B'])
...
add_component('PLAYER', ['ACCEL_FORCE',
                         'ACCEL_INPUT',
                         'REVERSE_FORCE',
                         'REVERSE_INPUT',
                         'TURN_FORCE',
